            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-5 well">
                     <h3 class="text-center text-primary">If you are not Registered Before</h3><hr/>
                      {{ Form::open(['route' => 'register_sign_up','method' => 'POST','class' => 'form-horizontal']) }}
                    ...
                    <div class="col-md-5 well" style="margin-left:20px;">
                        <h3 class="text-center">Already Registered? Login here.....!</h3><hr/>
