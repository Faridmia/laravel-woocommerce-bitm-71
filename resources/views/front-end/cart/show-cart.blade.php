                    ...
                    <div class="col-md-11 col-md-offset-1">
                        ...
                        <table class="table table-bordered table-responsive">
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset($cartProduct->options->image) }}" alt="product image" height="50" width="50"/></td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th class="bg-success">Item Total (Tk. )</th>
                                <td>{{ $sum }}</td>
                            </tr>
                            <tr>
                                <th class="bg-success">Vat Total (Tk. )</th>
                                <td>{{ $vat = 0 }}</td>
                            </tr>
                            <tr>
                                <th class="bg-success">Grand Total (Tk. )</th>
